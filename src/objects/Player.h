...
public:
    ...
    struct Stationary {
        constexpr bool operator==(const Stationary& other) const noexcept { return true; }
    };
    ...
    struct Moving {
        ...
        constexpr bool operator==(const Moving& other) const noexcept {
            return speed == other.speed && dir == other.dir;
        }
    };
    ...
    struct JumpingOnPath {
        ...
        constexpr bool operator==(const JumpingOnPath& other) const noexcept {
            return terrainPos == other.terrainPos && terrainSpeed == other.terrainSpeed && velocity == other.velocity;
        }
    };
