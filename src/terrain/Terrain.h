...
private:
    ...
    static constexpr GLfloat* setGLVertexData(GLfloat* dataPtr, const glm::vec3& pos, const float u, const float v, const glm::vec3& normal)
    {
        // position
        *dataPtr++ = pos.x;
        *dataPtr++ = pos.y;
    ...
    static GLfloat* copyGLVertexData(GLfloat* dataPtr, const GLfloat * const src, const float u, const float v)
    {
